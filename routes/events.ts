...
import { uploadEventImageToMinIO } from '../middleware/minioUpload';
import {
  getEvents,
  getEvent,
  createEvent,
...
router.post('/', uploadEventImageToMinIO, createEvent);
router.put('/:id', uploadEventImageToMinIO, updateEvent);
