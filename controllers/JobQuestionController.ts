...
export async function getJobQuestion(req: Request, res: Response) {
...
export async function createJobQuestion(req: Request, res: Response) {
...
export async function updateJobQuestion(req: Request, res: Response) {
...
export async function deleteJobQuestion(req: Request, res: Response) {
