...
const QuizAnswerController = __importStar(require("../controllers/QuizAnswerController"));
const auth_1 = require("../middleware/auth");
const router = (0, express_1.Router)();
router.use(auth_1.authenticateToken);
router.get("/", QuizAnswerController.listQuizAnswers);
router.get("/:id", QuizAnswerController.getQuizAnswer);
router.post("/", auth_1.requireStudent, QuizAnswerController.createQuizAnswer);
