...
const CourseEnrollmentController = __importStar(require("../controllers/CourseEnrollmentController"));
...
router.post("/", auth_1.requireStudent, CourseEnrollmentController.createCourseEnrollment);
