...
const StudentNoteController = __importStar(require("../controllers/StudentNoteController"));
const auth_1 = require("../middleware/auth");
const router = (0, express_1.Router)();
router.use(auth_1.authenticateToken);
router.get("/", StudentNoteController.listStudentNotes);
router.get("/:id", StudentNoteController.getStudentNote);
router.post("/", auth_1.requireStudent, StudentNoteController.createStudentNote);
